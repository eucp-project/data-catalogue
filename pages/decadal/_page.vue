<template>
  <div class="flex gap-8 items-stretch">
    <div class="relative w-2/3">
      ...
      <a :href="urlGitHub(page.path, page.extension)" target="_blank" class="absolute block -bottom-5 right-0">
    ...
    <div v-if="page.img" class="flex flex-col w-1/3">
...
export default {
  async asyncData ({ $content, params }) {
    const page = await $content('decadal', params.page).fetch()
    return {
      page
    }
  },
