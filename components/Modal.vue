<template>
  ...
  >
    ...
    >
      <button
        class="h-12 bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 rounded-full float-right"
        @click="$emit('close-modal')"
      >
        Close
      </button>
      ...
      <span class="float-right">
        <a :href="urlGitHub(dataset.path, dataset.extension)" target="_blank">
          <svg class="h-5 prose" viewBox="0 0 134 16">
